...
**0.**  Take a look at the existing [issues](https://github.com/LetsGrowMoreCommunity/WebDev-Playyard/issues) or create your own issues. Wait for the Issue to be assigned to you after which you can start working on it.

**1.**  Fork [this](https://github.com/LetsGrowMoreCommunity/WebDev-Playyard) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_user_name>/WebDev-Playyard.git
```
